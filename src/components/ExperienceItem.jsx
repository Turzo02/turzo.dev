...
export const ExperienceItem = ({ role, company, period, description, skills, isLatest }) => {
  return (
    <div className="relative pl-8 md:pl-12 transition-all duration-1000">
      <div className={`absolute -left-2.25 top-0 h-4.5 w-4.5 rounded-full bg-white dark:bg-slate-900 border-4 ${isLatest ? 'border-indigo-500 animate-pulse shadow-lg shadow-indigo-500/40' : 'border-slate-400 dark:border-slate-600'}`}></div>
      <div className="flex flex-col md:flex-row gap-6 md:gap-12">
        <div className="md:w-1/3">
          <h4 className="text-slate-900 dark:text-white font-display font-bold text-xl">{role}</h4>
        ...
        <div className="md:w-2/3 bg-white/20 dark:bg-white/5 border border-white/30 dark:border-white/10 p-8 rounded-4xl backdrop-blur-md hover:bg-white/40 dark:hover:bg-white/10 hover:ring-1 hover:ring-indigo-500/15 transition-all duration-300 shadow-sm">
