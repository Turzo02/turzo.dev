...
export const AboutSection = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // 1. Section Headline: Slide from left
      gsap.fromTo(
        ".about-headline",
        {
          x: -100,
      ...
      // 2. Bio Paragraphs: Stagger slide from right
      gsap.fromTo(
        ".about-bio p",
        {
          x: -100,
      ...
      // 3. Personality Cards: Slide from bottom
      gsap.fromTo(
        ".about-card",
        {
          x: 100,
  ...
  return (
    <section
      id="about"
      ref={containerRef}
      className="w-full py-32 px-4 md:px-8 overflow-hidden"
    >
      <div className="max-w-7xl w-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          {/* Personality Cards */}
          <div className="about-cards-container lg:col-span-5 grid grid-cols-2 gap-4">
            <div className="about-card col-span-2 p-8 rounded-[2.5rem] bg-white/30 dark:bg-white/5 border border-white/40 dark:border-white/10 backdrop-blur-xl flex flex-col justify-between group hover:border-indigo-500/50 transition-all duration-500 shadow-xl opacity-0">
            ...
            <div className="about-card p-6 rounded-[2.5rem] bg-white/30 dark:bg-white/5 border border-white/40 dark:border-white/10 backdrop-blur-xl flex flex-col gap-4 hover:-translate-y-2 transition-all shadow-lg opacity-0">
